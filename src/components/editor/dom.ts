...
export const addToVDom = (
  ...
  return components.map((component) => {
    // If we find the parent, append the new element to its children
    ...
    // Otherwise, recurse into the children to find the parent
    return {
      ...component,
      children: addToVDom(component.children, element, parent_id),
    };
  });
};